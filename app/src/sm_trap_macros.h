...
#ifndef SM_TRAP_MACROS_
#define SM_TRAP_MACROS_
 ...
 *  Alternatives to these functions are available in sm_util.h.
 */
#define nrf_modem_at_printf(...) function_disallowed_use_sm_util_printf_alternative(__VA_ARGS__)
