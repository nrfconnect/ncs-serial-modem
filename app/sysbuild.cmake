...
if(MCUBOOT_BAKE_PUBKEY)
  if(NOT EXISTS "${MCUBOOT_BAKE_PUBKEY}")
    message(WARNING "MCUBOOT_BAKE_PUBKEY does not exist: ${MCUBOOT_BAKE_PUBKEY}")
  endif()
  set(_baked 0)
...
if(MCUBOOT_BAKE_PUBKEY_2)
  if(NOT MCUBOOT_BAKE_PUBKEY)
    message(WARNING "MCUBOOT_BAKE_PUBKEY_2 requires MCUBOOT_BAKE_PUBKEY to also be set")
  endif()
  if(NOT EXISTS "${MCUBOOT_BAKE_PUBKEY_2}")
    message(WARNING "MCUBOOT_BAKE_PUBKEY_2 does not exist: ${MCUBOOT_BAKE_PUBKEY_2}")
  endif()
