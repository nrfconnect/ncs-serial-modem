...
{
	const char *response;
	int max_sockets = CONFIG_POSIX_OPEN_MAX;

	/* Create maximum number of sockets (determined by CONFIG_POSIX_OPEN_MAX) */
	...
	/* Attempt to create one more socket - should fail */
	send_at_command("AT#XSOCKET=1,1,0\r\n");
