...
This document describes the signing procedures for the nRF91M1 serial modem application.

The signing procedures are intended to be used by Nordic employees working with nRF91M1.
The procedures are made public to allow external parties to understand the signing workflow.
