...
.. note::
   ...
   UDP packets that exceed the MTU (Maximum Transmission Unit) of any network segment along their path may be dropped or fragmented, increasing the risk of packet loss.
