...
<evt_type>
   Integer.
   The type of the event, followed by a variable number of parameters depending on the event type.
...
<cmd>
   String.
   The carrier library command to execute.
...
<cmd>
   String.
   The carrier library configuration command to execute.
   Can be used as follows:
